            ...
            <div className='w-full h-full '>
                  ...
                  <div className="flex gap-12">
                    <span className="rounded-lg floatt" style={{ "--i": 0 }}>
                      <img
                        src={tinderimg}
                        alt=""
                        className="w-20 h-20 rounded-2xl shadow-lg floatt"
                      />
                    </span>
                    ...
                    <span
                      className="w-20 h-20 bg-[#FE5A84] rounded-2xl shadow-lg p-1 floatt"
                      style={{ "--i": 0 }}>
                ...
                <div className="w-full max-h-16 bg-white rounded-lg flex justify-center items-center mt-20">
                  <p className="text-black text-sm text-justify">
                    Les hommes sur les applications de rencontres peuvent
                    ressentir une pression intense pour correspondre à des
                    normes culturelles préconçues de la masculinité. Les
                    attentes traditionnelles, telles que la confiance en soi,
                    l'indépendance émotionnelle et même des caractéristiques
                    physiques spécifiques, peuvent créer une pression constante.
                    Cela peut conduire à une altération de l'authenticité, les
                    hommes cherchant à projeter une image conforme aux attentes
                    plutôt que de montrer leur véritable identité.
                  </p>
                </div>

                <div className="w-full max-h-16 bg-white rounded-lg flex justify-center items-center flex-col mt-12">
                  <p className="text-black text-sm">
                    Certains comportements aparaissent pour apaiser cette
                    pression comme{" "}
                ...
                <div>
                    ...
                    <div className="h-48 w-full border-gradient2 p-4 rounded-lg z-10">
                      <div className="bg-white w-full h-full flex justify-center items-center ">
                        <p className="text-sm text-black text-justify">
                          La compétition dans les applications de rencontres
                          crée une atmosphère où les hommes se comparent
                          constamment les uns aux autres. On évalue non
                          seulement l'apparence, mais aussi le succès
                          professionnel, l'intelligence, et d'autres critères
                          sociaux. Cette comparaison constante peut rendre
                          certains hommes anxieux et moins sûrs d'eux, ce qui
                          rend la recherche d'un partenaire plus stressante. En
                          d'autres termes, l'environnement compétitif de ces
                          applications peut susciter des sentiments d'insécurité
                          et d'infériorité chez certains hommes, compliquant
                          ainsi leur quête de relations amoureuses.
                        </p>
                      </div>
                    </div>

                    <motion.div
                      className="h-48 w-full border-gradient p-4 cardtextedroite z-9 "
                      ref={suiteTexte}
                      drag="x"
                      dragConstraints={{ left: -715, right: 0 }}
                      initial={{ x: -715 }}>
                      <div className="bg-white w-full h-full flex justify-center items-center gap-8 ">
                        <div className="w-[90%] flex justify-center items-center  h-full">
                          <p className="text-sm text-black text-justify ">
                            Cette pression permanente de se mesurer aux autres
                            peut également créer un climat anxiogène, où les
                            individus se sentent constamment jugés par des
                            critères parfois idéalisés. En résumé, la
                            compétition et la comparaison sociale dans ces
                            applications peuvent avoir des conséquences
                            significatives sur le bien-être émotionnel des
                            hommes qui y participent, soulignant la nécessité
                            d'une réflexion sur les dynamiques induites par ces
                  ...
                  <div className="w-full max-h-16 bg-white rounded-lg flex justify-center items-center mt-12">
                    <span className="textgr font-bold text-3xl flex text-center justify-center items-center gap-2">
                      Peur du Rejet ou de l'Échec sur la Santé Mentale Masculine
                      <span className="text-sm "></span>
                    </span>
                  </div>
                  ...
                  <div className="w-full max-h-32  bg-white rounded-lg  mt-8 ">
                    <div className="w-[70%] h-full bg-white border-[#ff0055] rounded-lg shadow-lg border-4 mx-auto">
                      <p className="p-4 text-black text-sm text-justify">
                        La nature impitoyable des rencontres en ligne peut
                        entraîner des expériences fréquentes de rejet ou
                        d'échec. Les hommes peuvent réagir différemment à ces
                        situations, mais pour beaucoup, cela peut avoir un
                        impact significatif sur leur santé mentale. La
                        répétition des rejets peut créer des sentiments de
                        désespoir, d'anxiété sociale et de dévalorisation
                        personnelle. Certains hommes peuvent internaliser ces
                        expériences négatives, compromettant ainsi leur estime
                        de soi et leur bien-être émotionnel.
                      </p>
                    </div>
                  </div>

                  <div className="w-full lg:h-96  bg-white rounded-lg  mt-8 ">
                    <div className="w-[100%] h-full bg-white  rounded-lg shadow-xl mx-auto flex justify-around items-center">
                      <div className="h-full w-full flex justify-center items-center">
                        <iframe
                          className="iframeetu rounded-lg shadow-xl border-4 border-[#E0861B]"
                          width="560"
                          height="315"
                          src="https://www.youtube.com/embed/KR4o1i6uyjk?si=ocmoMT2Dz77fO99n"
                          title="YouTube video player"
                          frameborder="0"
                          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                          allowfullscreen></iframe>{" "}
                      ...
                      <div className=" h-full w-full flex justify-center items-center relative">
                        ...
                        <div className="flex max-h-32 w-[80%] border-[#ff0055]">
                          <p
                            className="italic text-black citafre textgr"
                            ref={citafre}>
                            Tu peux être affecté par certaines choses sur
                            l'application, comme le fait de ne pas avoir de
                            likes. Le fait de catégoriser ou de se faire
                            catégoriser peut baisser le morale où le monter.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="w-full max-h-32  bg-white rounded-lg  mt-8 ">
                    <div className="w-[85%] h-full gradient bg-cover  rounded-lg shadow-lg border-4 mx-auto">
                      <p className="p-4 text-white text-xl text-justify">
                        En somme, les tensions masculines dans le monde des
                        applications de rencontres sont profondément ancrées
                        dans les normes culturelles et les dynamiques sociales.
                        Comprendre ces pressions est essentiel pour favoriser
                        des interactions plus saines et promouvoir la santé
                        mentale des hommes engagés dans ces espaces virtuels de
                        recherche d'amour.
                      </p>
                    </div>
                  </div>
